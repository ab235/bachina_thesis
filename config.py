...
EVAL_TOKEN_SIZE = _env_int("EVAL_TOKEN_SIZE", 128)
EVAL_OVERLAP = _env_int("EVAL_OVERLAP", 32)
...
EVAL_MIN_CHARS = _env_int("EVAL_MIN_CHARS", 100)
EVAL_MAX_CHARS = _env_int("EVAL_MAX_CHARS", 600)
EVAL_SIMILARITY_THRESHOLD = _env_float("EVAL_SIMILARITY_THRESHOLD", 0.6)
...
EVAL_HOTPOT_SP_MAX_FACTS = _env_int("EVAL_HOTPOT_SP_MAX_FACTS", 10)
...
EVAL_GPU_ID = _env_int("EVAL_GPU_ID", 0)
