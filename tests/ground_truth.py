...
KEYWORD_MAP: Dict[str, Tuple[str, ...]] = {
    "sbr-001": ("citizens", "rights", "community"),
    "sbr-002": ("admission", "qualified", "diverse"),
    "sbr-003": ("facilities", "discrimination", "restrictions"),
    "sbr-004": ("eligibility", "requirements", "funding"),
    "sbr-005": ("discussion", "inquiry", "exception"),
    "sbr-006": ("syllabus", "grading", "dishonesty"),
    "sbr-007": ("academic", "prejudiced", "evaluation"),
    "sbr-008": ("activities", "confidential", "honest"),
    "sbr-009": ("records", "authorized", "contest"),
    "sbr-010": ("associations", "recognition", "discrimination"),
    "sbr-011": ("discuss", "speakers", "procedures"),
    "sbr-012": ("editorial", "standards", "opinions"),
    "sbr-013": ("policy", "government", "procedures"),
    "sbr-014": ("speech", "assembly", "lawfully"),
    "sbr-015": ("counsel", "authorities", "safety"),
    "sbr-016": ("fair", "rules", "inquiry"),
    "sbr-017": ("charges", "refute", "appeal"),
    "sbr-018": ("warrant", "approval", "safety"),
    "sbr-019": ("rights", "harassment", "admissions"),
    "sbr-020": ("suspension", "safety", "review"),
    "sbr-021": ("individuality", "standards", "rights"),
    "sbr-022": ("misconduct", "threatens", "processes"),
    "sbr-023": ("organizations", "protect", "officers"),
    "sbr-024": ("authority", "dean", "president"),
    "sbr-025": ("conduct", "violating", "law"),
    "sbr-026": ("disrupts", "rights", "activities"),
    "sbr-027": ("theft", "keys", "entry"),
    "sbr-028": ("damage", "property", "vandalism"),
    "sbr-029": ("academic", "dishonesty", "violation"),
    "sbr-030": ("fraud", "forgery", "records"),
    "sbr-031": ("using", "distributing", "paraphernalia"),
    ...
    "sbr-036": ("tampering", "fires", "recklessly"),
    "sbr-037": ("weapons", "chemicals", "explosive"),
    "sbr-038": ("comply", "identification", "information"),
    "sbr-039": ("harms", "hostile", "protected"),
    "sbr-040": ("victim", "institute", "status"),
    "sbr-041": ("status", "facilitate", "jurisdiction"),
    "sbr-042": ("sponsored", "events", "organization"),
    "sbr-043": ("infractions", "reputation", "safety"),
    "sbr-044": ("preponderance", "evidence", "standard"),
    "sbr-045": ("appear", "truthfully", "adviser"),
    "sbr-046": ("request", "three", "defer"),
    "sbr-047": ("appeals", "evidence", "sanctions"),
    "sbr-048": ("fraud", "documentation", "grading"),
    "sbr-049": ("plagiarism", "acknowledgment", "citing"),
    "sbr-050": ("assistance", "treatment", "judicial"),
}
